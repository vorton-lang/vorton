...
pub const BUILTIN_METHOD_FLOAT_EQ: Int = 34
pub const BUILTIN_METHOD_STR_EQ: Int = 35
pub const BUILTIN_METHOD_BOOL_EQ: Int = 36
pub const BUILTIN_METHOD_INT_CLONE: Int = 37
pub const BUILTIN_METHOD_FLOAT_CLONE: Int = 38
pub const BUILTIN_METHOD_STR_CLONE: Int = 39
pub const BUILTIN_METHOD_BOOL_CLONE: Int = 40
pub const BUILTIN_METHOD_INT_CMP: Int = 41
pub const BUILTIN_METHOD_FLOAT_CMP: Int = 42
pub const BUILTIN_METHOD_STR_CMP: Int = 43
pub const BUILTIN_METHOD_BOOL_CMP: Int = 44
pub const BUILTIN_METHOD_INT_DEBUG: Int = 45
pub const BUILTIN_METHOD_FLOAT_DEBUG: Int = 46
pub const BUILTIN_METHOD_STR_DEBUG: Int = 47
pub const BUILTIN_METHOD_BOOL_DEBUG: Int = 48
pub const BUILTIN_METHOD_INT_HASH: Int = 49
pub const BUILTIN_METHOD_STR_HASH: Int = 50
pub const BUILTIN_METHOD_BOOL_HASH: Int = 51
pub const BUILTIN_METHOD_PTR_ADDR: Int = 52
pub const BUILTIN_METHOD_PTR_CAST: Int = 53
pub const BUILTIN_METHOD_PTR_OFFSET: Int = 54
pub const BUILTIN_METHOD_PTR_READ: Int = 55
pub const BUILTIN_METHOD_PTR_TAKE: Int = 56
pub const BUILTIN_METHOD_PTR_WRITE: Int = 57
...
pub fn impl_method_ref_stable_key(value: ImplMethodRef) -> Str {
    ...
    parts.push(identity_key_atom(
        impl_method_ref_source_member_index(value).to_str()))
    parts.push(identity_key_atom(
        impl_method_ref_callable_slot_index(value).to_str()))
    parts.push(identity_key_atom(impl_method_ref_name(value)))
    parts.join("/")
}
